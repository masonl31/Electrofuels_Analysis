...
* File last time modified 2005.11.20 (hr), 20080414(hr), 20120914(hr)
...
PUT$(BALBASE3.MODELSTAT GE 20) " Error no. " BALBASE3.MODELSTAT:3:0 " ";
...
PUT$(BALBASE3.SOLVESTAT GE 4)  " Non optimal - error no.  " BALBASE3.SOLVESTAT:3:0
;
